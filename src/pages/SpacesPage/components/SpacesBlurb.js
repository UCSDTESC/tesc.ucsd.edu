...
class SpacesBlurb extends React.Component {
        ...
        return (
            <section className="about">
                ...
                <div className="col-md text-center">
                    <a className="btn btn-cta" href="http://tinyurl.com/projectspacescontract">Project Spaces Allocation Agreement</a>
                </div>
                <div className="col-md text-center">
                    <a className="btn btn-cta" href="https://goo.gl/forms/hs0hsuzpMySiy9vi1">Project Space Request Form</a>
                </div>
                </div>
            </section>
        );
