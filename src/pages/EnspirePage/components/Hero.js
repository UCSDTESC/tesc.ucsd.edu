        ...
        return (
            <section className="w-100 h-100 d-flex align-items-center justify-content-center enspire-hero">
                <div className="container-fluid text-center enspire-contents">
                    <img
                        className="enspire-hero__logo"
                        src="/Enspire-logo-text-blue.svg"
                        alt="Enspire logo"
                    />
                    <p>
                        <br />
                        ...
                        <br />
                        Explore UCSD for a day of fun and engaging engineering
                        activities.
                    </p>
                    <a
                        href="https://forms.gle/pmTdHGC7gmA6MdE2A"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <button
                            type="button"
                            className="btn btn-outline-primary btn-custom-large btn-space-right"
                        >
                            Register Now
                        </button>
                    </a>
