...
class Footer extends Component {
    ...
    render() {
        return (
            <div>
                <section className="contact enspire-contact" id="contact">
                    <div class="container-fluid d-flex align-items-center h-100">
                        <h1 class="contact__header m-auto">
                            Talk to us at <a class="enspire-contact__link" href="mailto:nicholas.fu@tesc.ucsd.edu">nicholas.fu@tesc.ucsd.edu</a> if you have any questions.
                        </h1>
                    </div>
                </section>
