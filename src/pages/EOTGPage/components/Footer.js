            ...
            <div>
                <section className="contact eotg-contact" id="contact">
                    <div className="container-fluid d-flex align-items-center h-100">
                        <h1 className="contact__header m-auto">
                            Talk to us at <a className="eotg-contact__link" href="mailto:johnny@tesc.ucsd.edu">johnny@tesc.ucsd.edu</a> if you have any questions.
                        </h1>
                    </div>
                </section>
                <footer className="footer" id="footer">
                    <div className="container-fluid">
                        ...
                        <li className="footer__link-item">
                            <a className="footer__link" target="_new" href="https://instagram.com/ucsdtesc/">
