...
const attendingOrgs = [
    ...
    },
    {
        name: 'ACM Cyber',
        description:
            'ACM Cyber is a sub-org of ACM UC San Diego Chapter with a special interest in cybersecurity! We have teams that will compete in various CTFs but we’ll also host workshops, industry panels, seminars, etc. throughout the year. We welcome everyone -- no experience or knowledge of cybersecurity is needed to join!',
        department:
            'Bioengineering, Computer Science and Engineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering, NanoEngineering, Structural Engineering, Data Science',
    ...
    },
    {
        ...
        acronym: 'ECE USC',
        description:
            'ECE USC strives to bridge the gap between the ECE department and student body, and enrich the ECE experience for undergraduates though various mentorship, community building, professional development, etc... events and programs.',
    ...
    },
    {
        ...
        acronym: 'IEEE',
        description:
            "IEEE UC San Diego Student Branch is part of a larger organization that spans internationally and focuses on innovating technology. Here at UCSD, our organization offers multiple projects and workshops throughout the year as well as other events, such as socials and professional development. Come check us out if you're interested in gaining project experience or even just to make new friends!",
        department: 'All',
    ...
    },
    {
        ...
        acronym: 'WIC',
        description:
            "We're coders and engineers - both women and men - who support the female presence in computing. We run events, from tech talks to socials, and provide opportunities for female engineers to connect and succeed.",
    ...
    },
    {
        ...
        department:
            'Computer Science and Engineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering',
    ...
    },
    {
        ...
        department:
            'Bioengineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering, NanoEngineering, Structural Engineering',
    ...
    },
    {
        ...
        description: (
            <>
                Our student chapter, active since 2009, is a subset of a global
                not-for-profit association that strives to advance
                pharmaceutical manufacturing professionals in their industry.
                The primary goal of UCSD ISPE is to educate and connect its
                student members with the biotechnology & biomedical industry by
                providing them with professional development opportunities. We
                do this through events such as:
                <ol>
                ...
                Previous events have included industry tours at Genentech and
                Life Technologies, internships at Abbott Vascular, attendance at
                the ALA Conference, and discussion panel with Biosite's top
                scientists.
            </>
        ),
    ...
    },
    {
        ...
        acronym: 'UBIC',
        description:
            "UBIC is a vibrant community of undergraduate bioinformaticians serving to expand, strengthen, and support UCSD's bioinformatics majors. we have been organizing chalk talk series for bioinformatics research, a bioinformatics bootcamp for freshman & sophomore, and also bioinformatics conference annually.",
        department: 'Bioengineering',
    ...
    },
    {
        ...
        acronym: 'AIAA',
        description:
            'The American Institute of Aeronautics and Astronautics at UCSD (AIAA@UCSD) is a pre-professional student organization here to serve our members by providing an inclusive and supportive group that emphasizes mentorship, learning, and interconnectivity. Our goal is to prepare and empower our members for a future in aerospace. We aim to connect students to a national network of industry and academic professionals, hiring managers, and high-profile members of the aerospace community.',
    ...
    },
    {
        ...
        acronym: 'CMAA',
        description:
            'The mission of the Construction Management Association of America at UCSD is to promote the profession of construction management at UCSD, and to provide students with resources and professional development opportunities in the construction industry.',
        department: 'Structural Engineering',
        link: '',
        email: '',
        day: 'Wednesday',
    },
    {
        ...
        acronym: 'RPL',
        description:
            'The Rocket Propulsion Laboratory (RPL) is a diverse, multidisciplinary team of passionate students with the common goal to design, test, and launch unique and innovative rockets.  We believe that everyone, no matter their major, skill level, or origins, should have the opportunity to pursue their dreams among the stars in a friendly, supportive, hands-on learning environment.  To that end, we seek to make RPL a team where everyone feels comfortable to think outside the box and develop strong professional, technical, and social skills while crafting the most complex and challenging rocket systems.',
        department:
            'Computer Science and Engineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering, Structural Engineering, Physics, Chemistry, Chemical Engineering',
    ...
    },
    {
        ...
        department:
            'Computer Science and Engineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering, NanoEngineering, Structural Engineering, Business',
    ...
    },
    {
        ...
        acronym: 'YNDR',
        description:
            'Yonder Dynamics is a student-run robotics organization that designs and builds a Mars rover to compete in the annual University Rover Challenge.',
        department:
            'Bioengineering, Computer Science and Engineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering',
    ...
    },
    {
        ...
        acronym: 'ESW',
        description:
            'We are the University of California, San Diego chapter of Engineers for a Sustainable World, a student-run organization dedicated to bringing communities together to develop, implement, and share sustainable technologies and practices worldwide.',
        department:
            'Bioengineering, Computer Science and Engineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering, NanoEngineering, Structural Engineering, Sustainability Department',
    ...
    },
    {
        ...
        description: (
            <>
                Envisionaries is an org dedicated to growing the campus maker
                community! We are run out of the Envision maker studio, and we
                host technical skills workshops, speaker series, and a variety
                of activities to help you grow as a maker. Meetings are every
                Monday from 7-8 pm. RSVP for the meeting here!{' '}
                <a
                    href="https://forms.gle/YVzaGHGNWAqrd2Cm7"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    https://forms.gle/YVzaGHGNWAqrd2Cm7
                </a>
            </>
        ),
        department: 'All',
    ...
    {
        name:
            'Out in Science, Technology, Engineering, and Mathematics at UCSD',
        acronym: 'oSTEM',
        description:
    ...
    },
    {
        ...
        acronym: 'SASE',
        description:
            'The Society of Asian Scientists and Engineers, or, SASE, for short, at UCSD is a pre-professional organization dedicated to promoting professional development and preparing undergraduates for their futures, whether it be graduate school, research in a lab, an engineer, or anything in-between. We help students by organizing professional events and workshops, such as our annual networking event Dining with Professionals, resume workshops, and more.',
        department:
            'Bioengineering, Computer Science and Engineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering, NanoEngineering, Structural Engineering, Science majors (Biology, Chemistry, etc.)',
    ...
    },
    {
        ...
        acronym: 'SWE',
        description:
            'Society of Women Engineers at UC San Diego informs, nurtures, and encourages women to attain high levels of education and professional achievement. Our members serve as role models to pre-college and engineering students.',
        department:
            'Bioengineering, Computer Science and Engineering, Electrical and Computing Engineering, Mechanical and Aerospace Engineering, NanoEngineering, Structural Engineering',
    ...
    },
    {
        ...
        acronym: 'CSES',
        description:
            'Computer Science and Engineering Society is the longest standing computer science organization at UCSD. At CSES, we aim to form a passionate community of computer scientists and engineers. As one of the widest-reaching CSE organizations at UCSD, CSES runs a variety of events to provide resources for the professional, social, & technical development of the CSE community on campus.',
        department: 'Computer Science and Engineering',
    ...
    },
    {
        ...
        acronym: '',
        description:
            'CS foreach is student outreach organization at UC San Diego dedicated to increasing access to computer science education in the San Diego area. Our work is focused on mentorship, education, and outreach with K-12 students.',
        department: 'Computer Science and Engineering',
    ...
    },
    {
        ...
        acronym: 'OS @ UCSD',
        description:
            'Open Source @ UCSD (OS) is an organization that contributes to and creates open source projects. Open source projects are projects for all interested UCSD students can participate in. Participation can vary between fixing known bugs or glitches to improving the project by adding new features. Open Source @ UCSD will be using these projects to help teach students core open source practices, which include Git and basic coding principles, in an inclusive environment. We will be providing technical workshops, projects, and contribute-a-thons throughout the year!',
        department:
            'Computer Science and Engineering, Electrical and Computing Engineering',
