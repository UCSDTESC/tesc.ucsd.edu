...
import { Elastic, TimelineMax, TweenMax, Linear, TimelineLite } from 'gsap';
        ...
        if (PLAY_ANIM) {
            ...
            new TimelineMax({ repeat: -1, yoyo: true })
                .fromTo(
                    ...
                    Anims.Gear.duration,
                    { y: Anims.Gear.yStart },
                    { y: Anims.Gear.yEnd, ease: Linear.easeInOut }
                )
                .fromTo(
                    Anims.Gear.elem,
                    Anims.Gear.duration,
                    { y: Anims.Gear.yEnd },
                    { y: Anims.Gear.yStart, ease: Linear.easeInOut }
                );

            TweenMax.to(Anims.Gear.elem, Anims.Gear.rotationDuration, {
                rotation: 360,
            ...
            //Beaker
            TweenMax.to(Anims.Beaker.elem, Anims.Beaker.duration, {
                rotation: Anims.Beaker.degree,
                ease: Linear.easeNone,
                repeat: -1,
                yoyo: true,
            ...
            new TimelineMax({ repeat: -1 }).fromTo(
                Anims.BeakerBubbles.elem,
                Anims.BeakerBubbles.duration,
                { y: Anims.BeakerBubbles.yStart },
                {
                    y: Anims.BeakerBubbles.yEnd,
            ...
            //Spanner
            TweenMax.to(Anims.Spanner.elem, Anims.Spanner.duration, {
                rotation: Anims.Spanner.degree,
                delay: 1,
                ease: Linear.easeInOut,
                repeat: -1,
                repeatDelay: 2,
