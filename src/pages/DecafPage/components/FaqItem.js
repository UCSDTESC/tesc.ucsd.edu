            ...
            <div className="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div className="panel panel-default question">
                    <div className="panel-heading" id={`heading-${idx}`} role="tab">
                        <div className="panel-title question__heading">
                    ...
                    <div className="panel-collapse collapse in question__content" id={`collapse-${idx}`} role="tabpanel" aria-labelledby={`heading-${idx}`}>
