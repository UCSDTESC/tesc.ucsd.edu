  ...
  return (
    <>
      <div className="col-md-3 m-0 px-1 py-1" id={id} ref={ref}>
        <div
          className={showFull ? `board__member-active-${idx}` : "board__member"}
          onClick={click}
        >
          <div
            src={data.img}
          ...
          <div className="text-center board__member-name">{data.name}</div>
          <div className="text-center board__member-title">{data.role}</div>
        </div>
          ...
          {data.link && (
            <div className="full__connect">
              ...
              <a target="_blank" href={data.link}>
                {" "}
                <span>LinkedIn</span> <i className="fab fa-linkedin-in" />
              </a>
            </div>
          )}
          <div className="full__connect">
            ...
            <a target="_blank" href={"mailto:" + data.email}>
              {" "}
              <span>{data.email}</span> <i className="far fa-envelope" />
            </a>
          </div>
        </div>
      </div>
