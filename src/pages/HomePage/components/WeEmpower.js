...
function WeEmpower(){
  ...
  const copy = ['designers', 'innovators', 'leaders', 'students', 'communities', 'creators', 'engineers']
  ...
  return (
    <div className="hero__copy">
      We empower{' '}       
      <span ref={wordRef} className={!animFinished ? 'hero__copy-word hero__copy-word__grey' : 'hero__copy-word'}></span>
    </div>
  );
}
