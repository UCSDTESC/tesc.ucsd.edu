...
function FAQBlurb() {
    return (
        <section className="about">
            ...
            <div className="about__text mt-4 text-left">
                <b>Who is currently in the TESC Council?</b>
            </div>
            <div className="about__text text-left">
            ...
            <div className="about__text mt-4 text-left">
                <b>What is the overall process/requirements for joining TESC?</b>
            </div>
            <div className="about__text text-left">
            ...
            <div className="about__text mt-4 text-left">
                <b>How does an org apply to be a probationary member?</b>
            </div>
            <div className="about__text text-left">
            ...
            <div className="about__text mt-4 text-left">
                <b>How does an org apply to be a full member?</b>
            </div>
            <div className="about__text text-left">
                An org is admitted into TESC after undergoing two stages of the application process. Before becoming a full member of TESC, orgs must apply to be a probationary member. 
            </div>
            ...
            <div className="about__text mt-4 text-left">
                <b>What does being a probationary member of TESC mean?</b>
            </div>
            <div className="about__text text-left">
                A probationary member of TESC does not yet have access to TESC funding and does not have voting representation at council meetings. However, probationary members do have access to event support. 
            </div>
            <div className="about__text mt-4 text-left">
                <b>What does being a full member of TESC mean?</b>
            </div>
            <div className="about__text text-left">
            ...
            <div className="about__text mt-4 text-left">
                <b>What are some of the events TESC holds?</b>
            </div>
            <div className="about__text text-left">
                <ul>
                    <li>
            ...
            <div className="about__text mt-4 text-left">
                <b>What happens if I miss a meeting?</b>
            </div>
            <div className="about__text text-left">
            ...
            <div className="about__text mt-4 text-left">
                <b>What TESC resources do I have access to?</b>
            </div>
            <div className="about__text text-left">
                <ul>
                    <li>
            ...
            <div className="about__text mt-4 text-left">
                <b>I haven’t been attending TESC events or council meetings for 1 quarter/2 quarters/a year. Am I still affiliated with TESC/can I still access TESC resources?</b>
            </div>
            <div className="about__text text-left">
            ...
            <div className="about__text mt-4 text-left">
                <b>Who can I contact to make sure I am no longer considered an inactive org?</b>
            </div>
            <div className="about__text text-left">
                Please email{' '}
                <a
            ...
            <div className="about__text mt-4 text-left">
                <b>Who can I contact if I have a question?</b>
            </div>
            <div className="about__text text-left">
                Please email{' '}
                <a
            ...
            <div className="about__text mt-4 text-left">
                <b>How to join the TESC email list?</b>
            </div>
            <div className="about__text text-left">
            ...
            <div className="about__text mt-4 text-left">
                <b>Does TESC have social media?</b>
            </div>
            <div className="about__text text-left">
            ...
            <div className="about__text mt-4 text-left">
                <b>Are you interested in joining TESC itself?</b>
            </div>
            <div className="about__text text-left">
                Apply here!{' '}
                <a
