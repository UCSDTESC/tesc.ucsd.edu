...
const board = [
  ...
  },
  {
    ...
    img:
      "https://tesc-website.s3.us-east-2.amazonaws.com/board/sdhacks-director-2020.jpg",
    email: "emily@tesc.ucsd.edu",
    bio:
      "I'm a fifth year computer engineering major as well as TESC's new SD Hacks Director. I'm also ACM's founder and past President, IEEE's past Vice Chair External, the ECE Alumni Board's student liaison, and a two time Google Software Engineering Intern. In my free time, I love to challenge my mind by competing in hackathons and my body by running marathons. To reward myself, I consume a ton of KBBQ and boba (almost daily)!",
    link: "https://www.linkedin.com/in/emilynguy/",
  },
  {
    name: "Stanley Lee",
    role: "Assistant SD Hacks Director",
    img:
      "https://tesc-website.s3.us-east-2.amazonaws.com/board/assistant-sd-hacks-2020.jpg",
    email: "stanley@tesc.ucsd.edu",
    bio:
      "I'm a third-year data science major with a minor in design! I'll be serving as the Assistant Director for SD Hacks and can't wait to meet everyone! In my free time I like watching cat videos, video editing, and playing games.",
    link: "https://www.linkedin.com/in/leestanleysg/",
  },
  {
    name: "Warren Chang",
  ...
  },
  {
    ...
    role: "Marketing Lead",
    img:
      "https://tesc-website.s3.us-east-2.amazonaws.com/board/marketing-lead-2020.JPG",
