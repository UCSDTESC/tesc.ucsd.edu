...
const oldReqs = [
    ...
    },
    {
        ...
        content: [
            ...
            <div>We approve funding requests based on the list of expenses submitted during the funding request process. This means we will not reimburse you for expenses that were not included in that list. If small changes need to be made to the initial budget (ie. different supplier), email the <a href="mailto:kyle.gillaspy@tesc.ucsd.edu" target="_blank">VP Finance</a> for approval.</div>,
    ...
    },
    {
        ...
        content: [
            ...
            <div>You will receive an email from the <a href="mailto:kyle.gillaspy@tesc.ucsd.edu" target="_blank">VP Finance</a> within two weeks of submitting the funding request either approving, partially approving, or denying your funding request. If you have not received an email from the VP Finance within two weeks, send an email to <a href="mailto:pvp@tesc.ucsd.edu" target="_blank">pvp@tesc.ucsd.edu</a></div>,
...
const newReqs = {
    ...
    content: [
        ...
        <div>
            An outreach event/initiative plan. Outreach events/initiatives are those where your goal is to interact with the future generation of engineers and/or historically underrepresented groups in engineering/STEM. For an outreach event to count, it must be on the <a href="http://bit.ly/TESCcaladd" target="_blank">Council events calendar</a> (email <a href="mailto:ysabelle@tesc.ucsd.edu" target="_blank">ysabelle@tesc.ucsd.edu</a> if your org does not have access) three weeks before the event happens. The calendar post needs to have the location, hosting organization, and someone to contact.
            <ul type='a'>
                <li>
                    An example may be putting on an event bringing high school students to UCSD or consistently visiting high schools.     
                </li>    
                <li>
                    General Body Meetings will not be considered as outreach events, nor are workshops where your target audience is your own organization.
                </li>
                <li>
                    If you don’t plan on running any outreach events, then do not submit a schedule. 
                </li>
                <li>
                    <i>We understand that some orgs do not schedule their outreach events far in advance. To accommodate these clubs, a simple statement of commitment to outreach events will suffice. (For instance, an org commits to 2 outreach events Fall quarter, 1 in Winter, 4 in Spring, etc.) Do not get too caught up on your Outreach Schedule - what is more important is that your outreach events go on the TESC Calendar, and that you follow through on your commitments!</i>
                </li>
            </ul>
        </div>,
        <div>The Funding Cycle application also contains questions about your organization. Do not wait until the last minute to fill it out.</div>
    ]
}
