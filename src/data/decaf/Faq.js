...
const studentFaq = [
    ...
    },
	{
	    ...
	    answer: <>We strongly recommend <a href="https://tesc.typeform.com/to/hwNBpM" target="_blank">uploading your resume</a> and signing up for <a target="_blank" href="https://ripplematch.com/index?r=7qszUz">RippleMatch</a>. Feel free to go to class 😅 or otherwise relax. If you've subscribed for notifications, we'll let you know when to come back. Note: the sooner you come back after your ticket number is called, the less time you'll need to wait in the per-ballroom line.</>
    },
	{
    ...
    },
    {
	    ...
	    answer: <>Check out the list of attending companies <a target="_blank" href="https://tesc.ucsd.edu/decaf/attending">here</a>. See the <a href="/decaf2020-map.pdf" target="_blank">map</a> for East and West Ballrooms to find out where companies are located.</>
    }
]
